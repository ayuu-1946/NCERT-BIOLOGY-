...
| 12. Ecosystem | ✅ Done |
| 13. Biodiversity and Conservation | ▶️ In progress — **Gate 2 GREEN · Gate 3(a) CLOSED**: script + 11-page PDF on the frozen template · 189/189 rows ticked · 23/23 figure labels in running text · `check_pdf.py` re-run this session, exit 0 (0 fail, 1 inspected benign warn) · Pass 3(a) inspected **11/11 pages** at 150 dpi and 300 dpi/1-bit B&W with **0 confirmed defects** and 3 flags dismissed as false positives. **Pass 3(b) bidirectional full read not begun**, so Gate 3 is open and this is **not Done** |
