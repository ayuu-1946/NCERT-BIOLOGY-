...
**Step 1 — Locate and extract (Pass 1, before writing the script):**
...
1. **Pass 1a / 1b** — inventory the first half, then the second half, into the SAME inventory file. Gate 1 is evaluated over the whole chapter only after 1b, so the frozen inventory is complete and nothing at the seam is double-covered or dropped. All figure extraction/conversion/verification and the full figure-label matrix are completed across 1a+1b before Gate 1.
