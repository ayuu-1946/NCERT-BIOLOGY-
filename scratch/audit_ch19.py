...
spec = importlib.util.spec_from_file_location('ef', 'notes/class 11/Ch19_ChemicalCoordinationAndIntegration/extract_figures.py')
...
for fid,pno,(x0,y0,x1,y1) in ef.FIGS:
    ...
    if not xs: print(f'fig_{fid}: no drawings (raster or artwork represented as image)'); continue
