...
ROWS = [
    ...
    ("1-S", "Intro", "definition", '"Therefore, a society with people having physically and functionally normal reproductive organs and normal emotional and behavioural interactions among them in all sex-related aspects might be called reproductively healthy."'),
    ...
    ("1-S", "3.2", "fact", '"Many couples, mostly the young, urban, working ones have even adopted an \'one child norm\'."'),
    ...
    ("1-S", "3.2", "fact", '"Therefore, as long as the mother breast-feeds the child fully, chances of conception are almost nil."'),
    ("1-S", "3.2", "number", '"However, this method has been reported to be effective only upto a maximum period of six months following parturition."'),
    ...
    ("1-S", "3.2", "fact", '"Spermicidal creams, jellies and foams are usually used alongwith these barriers to increase their contraceptive efficiency."'),
    ...
    ("1-S", "3.2", "number", '"Pills have to be taken daily for a period of 21 days starting preferably within the first five days of menstrual cycle."'),
    ...
    ("1-S", "3.2", "term", '"Surgical methods, also called sterilisation, are generally advised for the male/female partner as a terminal method to prevent any more pregnancies."'),
    ...
    ("1-S", "3.2", "fact", '"It needs to be emphasised that the selection of a suitable contraceptive method and its use should always be undertaken in consultation with qualified medical professionals."'),
    ...
    ("1-S", "3.2", "fact", '"However, their possible ill-effects like nausea, abdominal pain, breakthrough bleeding, irregular menstrual bleeding or even breast cancer, though not very significant, should not be totally ignored."'),
    ...
    ("1-S", "3.3", "number", '"MTPs are considered relatively safe during the first trimester, i.e., upto 12 weeks of pregnancy."'),
    ("1-S", "3.3", "fact", '"Second trimester abortions are much more riskier."'),
    ("1-S", "3.3", "fact", '"One disturbing trend observed is that a majority of the MTPs are performed illegally by unqualified quacks which are not only unsafe but could be fatal too."'),
    ...
    ("1-S", "3.3", "number", '"According to this Act, a pregnancy may be terminated on certain considered grounds within the first 12 weeks of pregnancy on the opinion of one registered medical practitioner."'),
    ...
    ("1-O", "3.4", "opener", '"Infections or diseases which are transmitted through sexual intercourse are collectively called sexually transmitted infections (STI) or venereal diseases (VD) or reproductive tract infections (RTI)."'),
    ...
    ("1-S", "3.4", "fact", '"Infected females may often be asymptomatic and hence, may remain undetected for long."'),
    ...
    ("1-S", "3.5", "fact", '"Therefore, these facilities are presently available only in very few centres in the country."'),
...
FIGURE_ROWS = [
    ...
    ("1-F", "3.1a", "caption", "No in-figure text labels - unlabelled line-art diagram."),
    ("1-F", "3.1b", "caption", "No in-figure text labels - unlabelled photograph."),
    ("1-F", "3.2", "caption", "No in-figure text labels - unlabelled photograph (Copper T device)."),
    ("1-F", "3.3", "caption", "No in-figure text labels - unlabelled photograph (implants held between fingers)."),
