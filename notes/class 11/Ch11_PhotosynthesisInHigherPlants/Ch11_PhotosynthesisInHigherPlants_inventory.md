...
| `fig_11_3a.png` | 7 | `(290, 135, 520, 300)` | Absorption spectrum panel with y-axis, curves, Chlorophyll *a*, Chlorophyll *b*, Carotenoids, and `(a)`. |
| `fig_11_3b.png` | 7 | `(290, 300, 520, 435)` | Action spectrum panel with y-axis, curve, and `(b)`. |
...
| `fig_11_5.png` | 9 | `(280, 100, 525, 290)` | Z scheme: Photosystems II/I, electron acceptors, LHCs, electron transport system, ATP/ADP+iP, NADPH/NADP+, water annotation, and arrows. |
