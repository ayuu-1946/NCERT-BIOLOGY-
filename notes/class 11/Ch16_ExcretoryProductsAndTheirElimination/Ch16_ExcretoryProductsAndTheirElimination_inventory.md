...
Tick legend: `x` = written into the script and verified present in the generated PDF. All 178 rows are unticked at this freeze; Pass 2 ticks them only as `check_pdf.py` confirms each on the built PDF.
