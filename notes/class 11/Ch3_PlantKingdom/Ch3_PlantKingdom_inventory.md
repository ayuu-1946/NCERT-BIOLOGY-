...
**Pass 2 has NOT begun.** No chapter notes script and no chapter PDF exist yet. Every
`Ticked` cell below is intentionally blank: Gate 1 does not require ticks (§6 Gate 1 lists
four requirements, none of them ticks), and `check_pdf.py` check 7 gates them at Gate 2.
An empty tick means "not yet written into the script", never "not required".
...
|----|-------|------|------------------------------------------------------------------|--------|
| L01 | Fig 3.1 (a) | Labels | Figure labels: "Daughter colony"; "Parent colony"; "part (a-i)"; "part (a-ii)" | |
| L02 | Fig 3.1 (b) | Labels | Figure labels: "Frond"; "Stipe"; "Holdfast"; "Air bladder"; "Midrib"; "part (b-i)"; "part (b-ii)"; "part (b-iii)" | |
| L03 | Fig 3.1 (c) | Labels | Figure labels: "Frond"; "Main axis"; "Branches"; "part (c-i)"; "part (c-ii)" | |
| L04 | Fig 3.2 (a)(b) | Labels | Figure labels: "Archegoniophore"; "Antheridiophore"; "Gemma cup"; "Rhizoids"; "panel (a)"; "panel (b)" | |
| L05 | Fig 3.2 (c)(d) | Labels | Figure labels: "Sporophyte"; "Gametophyte"; "Capsule"; "Seta"; "Leaves"; "Main axis"; "Rhizoids"; "Antheridial branch"; "Archegonial branch"; "Branches"; "panel (c)"; "panel (d)" | |
| L06 | Fig 3.3 (a)(b) | Labels | Figure labels: "Leaves"; "Stem"; "Roots"; "Strobilus"; "Node"; "Internode"; "Branch"; "Rhizome"; "panel (a)"; "panel (b)" | |
| L07 | Fig 3.3 (c)(d) | Labels | Figure labels: "panel (c)"; "panel (d)" | |
| L08 | Fig 3.4 (a) | Labels | Figure labels: "panel (a)" | |
| L09 | Fig 3.4 (b) | Labels | Figure labels: "panel (b)" | |
| L10 | Fig 3.4 (c) | Labels | Figure labels: "Dwarf Shoot"; "Long Shoot"; "Seeds"; "panel (c)" | |
| L11 | Fig 3.5 (a)(b) | Labels | Figure labels: "panel (a)"; "panel (b)" | |
