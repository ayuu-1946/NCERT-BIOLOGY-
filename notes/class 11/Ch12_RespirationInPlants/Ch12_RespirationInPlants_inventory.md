...
### Heading rows — 12 total = 9 numbered + the 3 unnumbered IDs below
- Numbered (9): F018 (12.1), F038 (12.2), F063 (12.3), F078 (12.4), F088 (12.4.1), F103 (12.4.2), F128 (12.5), F139 (12.6), F152 (12.7)
- Unnumbered (3): F001 (Chapter title), F163 (Summary), F164 (Exercises)
- 9 + 3 = 12. This chapter has no unnumbered sub-headings sitting inside a numbered section; every heading in the source is either a numbered section/sub-section or one of the three unnumbered structural headings above.

### Opener rows — 10 total
...
|---|---|---|
| "Plants unlike animals have no special systems for breathing or gaseous exchange. Stomata and lenticels allow gaseous exchange by diffusion." | BODY-PRESENT | F021, F029 |
| "Almost all living cells in a plant have their surfaces exposed to air." | BODY-PRESENT | F029 |
| "The breaking of C-C bonds of complex organic molecules by oxidation leading to the release of a lot of energy is called cellular respiration." | BODY-PRESENT | F011 |
| "Glucose is the favoured substrate for respiration. Fats and proteins can also be broken down to yield energy." | BODY-PRESENT | F140, F013 |
| "The initial stage of cellular respiration takes place in the cytoplasm." | BODY-PRESENT | F042 |
| "Each glucose molecule is broken through a series of enzyme catalysed reactions into two molecules of pyruvic acid. This process is called glycolysis." | BODY-PRESENT | F043, F037 |
| "The fate of the pyruvate depends on the availability of oxygen and the organism." | BODY-PRESENT | F057, F058 |
| "Under anaerobic conditions either lactic acid fermentation or alcohol fermentation occurs." | BODY-PRESENT | F058, F064, F066 |
| "Fermentation takes place under anaerobic conditions in many prokaryotes, unicellular eukaryotes and in germinating seeds." | SUMMARY-UNIQUE ("germinating seeds") | F072 |
| "In eukaryotic organisms aerobic respiration occurs in the presence of oxygen. Pyruvic acid is transported into the mitochondria where it is converted into acetyl CoA with the release of CO2." | BODY-PRESENT | F075, F079, F085 |
| "Acetyl CoA then enters the tricarboxylic acid pathway or Krebs' cycle operating in the matrix of the mitochondria." | BODY-PRESENT | F087, F088 |
| "NADH + H+ and FADH2 are generated in the Krebs' cycle." | BODY-PRESENT | F096 |
| "The energy in these molecules as well as that in the NADH + H+ synthesised during glycolysis are used to synthesise ATP." | BODY-PRESENT | F118, F131 |
| "This is accomplished through a system of electron carriers called electron transport system (ETS) located on the inner membrane of the mitochondria." | BODY-PRESENT | F106 |
| "The electrons, as they move through the system, release enough energy that are trapped to synthesise ATP. This is called oxidative phosphorylation." | BODY-PRESENT | F112, F117 |
| "In this process O2 is the ultimate acceptor of electrons and it gets reduced to water." | BODY-PRESENT | F105, F116 |
| "The respiratory pathway is an amphibolic pathway as it involves both anabolism and catabolism." | BODY-PRESENT | F149 |
| "The respiratory quotient depends upon the type of respiratory substance used during respiration." | BODY-PRESENT | F156 |

## Exercise-gap terms
| Term/fact assumed by exercises | Explained where |
|---|---|
| Q1(a) Respiration vs Combustion — "combustion" and its heat loss | F030 (complete combustion yields heat), F011/F014 (respiration is stepwise, enzyme-controlled, traps ATP) |
| Q1(b) Glycolysis vs Krebs' cycle | F037–F058 (glycolysis), F088–F100 (Krebs' cycle) |
| Q1(c)/Q7(a) Aerobic respiration vs Fermentation / Anaerobic | F073–F075, F136–F138 (comparison bullets) |
| Q2 Respiratory substrates; most common substrate | F012 (definition), F013 + F140 (carbohydrates/glucose favoured) |
| Q3 Schematic of glycolysis | Fig 12.1 (F061/F062) + F049–F056 |
| Q4 Main steps in aerobic respiration; where it takes place | F079–F087 (pyruvate to acetyl CoA + matrix), F082, F106 |
| Q5 Schematic overview of Krebs' cycle | Fig 12.3 (F101/F102) + F088–F100 |
| Q6 Explain ETS | F103–F123 |
| Q7(c) Glycolysis vs Citric acid cycle | F037–F058 vs F088–F100 |
| Q8 Assumptions in net-ATP calculation | F130–F133 |
| Q9 Amphibolic pathway | F139–F149 |
| Q10 Define RQ; value for fats | F154 (RQ definition), F159/F160 (fats RQ = 0.7) |
| Q11 Oxidative phosphorylation | F117 |
| Q12 Significance of step-wise release of energy | F014, F032 |

No exercise assumes a term the body never explains; every exercise maps to at least one Facts row. "germinating seeds" (Q on fermentation sites) is covered via the folded SUMMARY-UNIQUE row F072.

## Figure manifest
| Fig # | Caption (verbatim) | Asset file | Source page | Mono | Verified |
|---|---|---|---|---|---|
| 12.1 | Steps of glycolysis | assets/fig_12_1.png | 4 | yes | yes |
| 12.2 | Major pathways of anaerobic respiration | assets/fig_12_2.png | 5 | yes | yes |
| 12.3 | The Citric acid cycle | assets/fig_12_3.png | 7 | yes | yes |
| 12.4 | Electron Transport System (ETS) | assets/fig_12_4.png | 8 | yes | yes |
| 12.5 | Diagramatic presentation of ATP synthesis in mitochondria | assets/fig_12_5.png | 9 | yes | yes |
| 12.6 | Interrelationship among metabolic pathways showing respiration mediated breakdown of different organic molecules to CO2 and H2O | assets/fig_12_6.png | 11 | yes | yes |

All six assets confirmed Pillow mode `L` (single-channel grayscale) and visually verified by the human reviewer; figure extraction, monochrome conversion, and label harvesting were completed in the dedicated 1-F session (see Ch12_TRACKER.md and Ch12_figure_audit.md).
...
[3]: `../../../../check_pdf.py` "Automated Pass 2 gate; its _extract_labels parses the Figure-label rows above"
[4]: `../../../../skills/ncert-figure-extraction/SKILL.md` "ncert-figure-extraction workflow"
