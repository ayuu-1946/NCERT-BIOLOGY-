...
FIGURES = [
    ...
    ('4_2ab', 2, (58,510,286,681), 'p2 diploblastic/triploblastic cross-sections; includes Mesoglea, Ectoderm, Endoderm, Mesoderm and (a)/(b)'),
    ...
    ('4_4', 4, (58,96,534,350), 'p4 broad Animalia classification; padded around yellow diagram, excludes footnote/caption'),
    ('4_5abc', 4, (58,408,270,672), 'p4 Porifera three-part specimen plate; includes (a)/(b)/(c), excludes caption'),
    ...
    ('4_8', 6, (54,112,220,355), 'p6 Pleurobrachia; includes full ctenophore and caption-side label area, excludes caption'),
    ...
    ('4_18', 11, (270,384,526,462), 'p11 Petromyzon; includes complete jawless fish and specimen label, excludes caption'),
    ('4_19ab', 11, (270,500,526,680), 'p11 Scoliodon/Pristis plate; includes both specimens and (a)/(b), excludes caption'),
    ('4_20ab', 12, (54,96,276,336), 'p12 Hippocampus/Catla plate; includes both specimens and (a)/(b), excludes caption'),
