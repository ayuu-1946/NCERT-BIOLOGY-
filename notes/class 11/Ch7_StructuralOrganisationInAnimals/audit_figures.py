"""Mandatory three-part crop audit for Class 11 Chapter 7 figure assets."""
import pymupdf
import numpy as np
from PIL import Image
from extract_figures import SRC, FIGS
    ...
    try:
        ...
        for fid, pno, (x0, y0, x1, y1) in FIGS:
            ...
            for d in page.get_drawings():
                ...
                ys += [r.y0, r.y1]
            if not xs:
                print(f'  fig_{fid}: no drawings (raster figure; check B not applicable)')
                continue
        ...
        for fid, pno, (x0, y0, x1, y1) in FIGS:
            ...
            for side, coords in bands.items():
                r = pymupdf.Rect(*coords) & page.rect
