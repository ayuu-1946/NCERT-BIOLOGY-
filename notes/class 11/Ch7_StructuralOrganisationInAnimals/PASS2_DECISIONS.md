...
- For the requested page flow, Figure 7.3 uses a 520-dpi vector crop and 12.5-cm maximum display width, placing the full cell-junction table at the start of the next page. Figure 7.17 uses a 7.5-cm maximum width so its image and caption fit on the preceding page. Both placements were visually checked; other figure sizes are unchanged.
