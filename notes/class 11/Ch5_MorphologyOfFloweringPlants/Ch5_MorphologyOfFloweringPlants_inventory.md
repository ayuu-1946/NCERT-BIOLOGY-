...
8. **`numpy` is an extra dependency** of this chapter’s `audit_figures.py`, beyond the four packages in the section-1 venv recipe: `uv pip install --python /vercel/share/neetenv/bin/python numpy`.
